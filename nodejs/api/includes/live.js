...
server.get('/live/positions', function (req, res, next) {
  ...
  request("http://5.196.39.50:27015/njs/location", function (error, response, body) {
...
server.get('/live/connected/:id', function (req, res, next) {
  ...
  request("http://5.196.39.50:27015/njs/connected/"+steamid, function (error, response, body) {
    if( error ) return res.send(new ERR.NotFoundError("ServerNotFound"));
...
server.get('/live/stats', function (req, res, next) {
  ...
  var obj = new Object();
  request("http://5.196.39.50:27015/njs/time", function (error, response, body) {
    try {
