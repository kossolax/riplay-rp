...
public Action Check_VehiclePolice(Handle timer, any none) {
	...
	if( EntRefToEntIndex(g_iVehicleHopital) <= 0 ) {
		...
		int car = rp_CreateVehicle(view_as<float>({984.0, -4389.0, 0.0 }), view_as<float>({0.0, 0.0, 0.0}), "models/props/crates/csgo_drop_crate_spectrum_v7.mdl", 0);
...
void displayBatteryMenu(int client){
	...
	CPrintToChat(driver, "" ...MOD_TAG... " %T", "Vehicle_Battery_Give", client);
