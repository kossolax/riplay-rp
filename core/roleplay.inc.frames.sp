...
void OnGameFrame_01(float time) {
	...
	for(int Client = 1; Client <= MaxClients; Client++) {
		...
		if( g_bUserData[Client][b_GameModePassive] == true && g_iUserData[Client][i_Job] >= 1 && g_iUserData[Client][i_Job] <= 8 || g_bUserData[Client][b_GameModePassive] == true && g_iUserData[Client][i_Job] >= 91 && g_iUserData[Client][i_Job] <= 95 ) {
