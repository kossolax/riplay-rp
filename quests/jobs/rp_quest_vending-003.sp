...
char g_poste[][][256] =  {
	...
	{ "Vous devez apporter aux armuriers les dernières règlementations concernant les armes. Pour cela, rendez-vous à l'armurerie.", "111" }, 
	{ "Vous devez apporter la liste des derniers explosifs aux artificiers. Pour cela, rendez-vous au magasin d'artifice.", "131" }, 
	{ "Vous devez apporter les derniers résultats de vente aux lotos. Pour cela, rendez-vous jusqu'au magasin de loterie.", "171" }, 
	{ "Vous devez apporter les derniers relevés de compte aux banquiers. Pour cela, rendez-vous à la Banque.", "211" }, 
	{ "Vous devez apporter la liste des nouvelles technologies aux techniciens. Pour cela, rendez-vous jusqu'à l'atelier des techniciens.", "221" }, 
};
